...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "LogiBack International. London HQ, Kenya Branch. Get paid in real KSh to review products. Withdraw to M-Pesa instantly." },
      ...
      { property: "og:url", content: "https://logiback.work/" },
      { property: "og:site_name", content: "LogiBack International" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "LogiBack International — Kenya Branch" },
      { name: "twitter:description", content: "Get paid in real KSh to review products. Withdraw to M-Pesa instantly." },
    ],
    links: [
