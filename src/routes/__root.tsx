...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Get paid in real KSh to review products. Withdraw to M-Pesa." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "LogiBack Earn — Kenya's Trusted Review Platform" },
      { name: "twitter:description", content: "Get paid in real KSh to review products. Withdraw to M-Pesa." },
    ],
    links: [
